...
function App(props) {
  // function : 함수
  // 함수는 변수에 담을 수 있는 값 => 함수의 파라미터로 들어갈 수 있다
  ...
  function action1(param1, param2) {
    ...
    return 2; // 리턴이 있거나 없거나
  }

  // 2. 이름 없는 함수 => 변수에 할당해서 쓸 수 있다
  // 파라미터 목록, 명령문
  ...
  // 3.1. 파라미터가 여러 개, 명령문이 여러 개 => 변수에 할당해서 쓸 수 있다
  ...
  //      파라미터가 한 개일 때 () 안써도됨...(하지만 prettier가 붙여줌)
  const c = (param1) => {
    // 명령문들...
  };
  const d = (param1) => {
